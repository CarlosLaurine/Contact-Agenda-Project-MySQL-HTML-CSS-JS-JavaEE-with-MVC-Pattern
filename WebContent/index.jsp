...
<body>
	...
	<div class="splash-container">
		<div class="splash">
			<h1 class="splash-head" style="margin-top: -3em;">Complete Contact Agenda
				Registration (CRUD) with JSP/MySQL and PDF Report Download (IText 5.5.13.2)</h1>
	...
	<div class="content-wrapper">
		<div class="content">
			...
			<div class="pure-g">
				...
				<p>
					<a href="https://github.com/CarlosLaurine/Responsive-Register-with-Ajax-Java.io-JSP-JSTL-JPA-PostgreSQL-JavaScript"
						class="pure-button pure-button-primary homeButton"
